        ...
        <div class="container1">
            ...
            <div class="container7">
                ...
                <div id="demandes">
                    ...
                    $sql = "SELECT * FROM adopteur "; 
                    $result = mysqli_query($conn, $sql);

                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            //checking if the demand is pinned before displaying it
                            $id_ad = $row["id_ad"];
                            $sql_pinned = "SELECT * FROM demander WHERE id_ad = '$id_ad' ORDER BY  id_dm DESC LIMIT 1";
                            $result_etat = mysqli_query($conn, $sql_pinned);
                            $row_etat = mysqli_fetch_assoc($result_etat);
                            $etat_d_a = $row_etat["etat_d_a"];
                            ...
                            if($etat_d_a == "pinned"){
                                ...
                                // Display adopteur demand information
                                echo "<div class='demande' id='demand-" . $row_etat['id_dm'] . "'>"; // Adding unique ID 

                                echo "<p><strong>Name:</strong> " . $row['nom_ad'] . " " . $row['prenom_ad'] . "</p>";
                                echo "<p><strong>Email:</strong> " . $row['email_ad'] . "</p>";
                                ...
                                //the add infos
                                echo "<p><strong>CIN:</strong> " . $row['cin_ad']. "</p>";
                                echo "<p><strong>Date of birth:</strong> " . $row['date_nai_ad'] . "</p>";
                                echo "<p><strong>Adress:</strong> " . $row['addr_ad'] . "</p>";
                                echo "<p><strong>Social status:</strong> " . $row['etat_soc_ad'] . "</p>";
                                echo "<p><strong>Profession:</strong> " . $row['pro_ad'] . "</p>";
                                echo "<p><strong>Phone number:</strong> " . $row['num_tele_ad'] . "</p>";
                                echo "<p><strong>Response of Q1:</strong> " . $row['q1_ad'] . "</p>";
                                echo "<p><strong>Response of Q2:</strong> " . $row['q2_ad'] . "</p>";
                                echo "<p><strong>Response of Q3:</strong> " . $row['q3_ad'] . "</p>";
                                echo "<p><strong>Response of Q4:</strong> " . $row['q4_ad'] . "</p>";
                                echo "<p><strong>Response of Q5:</strong> " . $row['q5_ad'] . "</p>";
                                echo "<p><strong>Response of Q6:</strong> " . $row['q6_ad'] . "</p>";
                                echo "<p><strong>Response of Q7:</strong> " . $row['q7_ad'] . "</p>";
                                echo "<p><strong>Response of Q8:</strong> " . $row['q8_ad'] . "</p>";
                                ...
                                echo "<button class='btn-accept' onclick='accepterDemande(" . $row['id_ad'] . ")'>Accept</button>";
                                echo "<button class='btn-refuser' onclick='refuserDemande(" . $row['id_ad'] . ")'>Refuse</button>";
                                echo "</div>";
                                echo "</div>";
                            }
                        ...
                        echo "No adopteur demands found.";
                    }
                    mysqli_close($conn);
                    ?>
                </div>
